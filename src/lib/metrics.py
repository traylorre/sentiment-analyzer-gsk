...
For On-Call Engineers:
    ...
    - ArticlesFetched: Raw count from Tiingo/Finnhub APIs
    ...
    | filter level = "ERROR"
    | filter correlation_id like /tiingo#/ or correlation_id like /finnhub#/
    | sort @timestamp desc
    ```
...
class StructuredLogger:
    ...
    Example output:
    {
        ...
        "correlation_id": "tiingo#abc123-req-456"
    }
    """
...
def get_correlation_id(source_id: str, context: Any) -> str:
    ...
    On-Call Note:
        ...
        aws logs filter-log-events \
          ...
          --filter-pattern "correlation_id tiingo#abc123-req-456"
    """

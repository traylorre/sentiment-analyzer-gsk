...
def build_key(source_id: str, timestamp: str) -> dict[str, str]:
    ...
    Args:
        source_id: Source identifier (e.g., "tiingo#abc123def456" or "finnhub#abc123def456")
    ...
    Example:
        >>> build_key("tiingo#abc123", "2025-11-17T14:30:00.000Z")
        {'source_id': 'tiingo#abc123', 'timestamp': '2025-11-17T14:30:00.000Z'}

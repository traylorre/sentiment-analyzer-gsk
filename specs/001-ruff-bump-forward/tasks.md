...
- [X] T016 [P] [US3] Record the 7 UP042 suppressions as a `CLEANUP-BOARD.html` kanban card. Satisfied by the card "7 UP042 noqa riders on (str, Enum) classes (was TD-023)", lane `nice`, which carries the location, root cause, guard test and proposed StrEnum migration. No further action.
